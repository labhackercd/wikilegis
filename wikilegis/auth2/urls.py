...
from wikilegis.auth2 import views
...
urlpatterns = [
    ...
    url(r'^activate/resend/$', views.resend_activation, name='resend_activation'),
...
urlpatterns += [
    ...
    url(r'^edit/$', views.your_profile, name='edit_profile'),
    url(r'^users/(?P<user_id>\d+)/$', views.show_users_profile, name='users_profile'),
]
