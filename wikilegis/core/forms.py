...
from wikilegis.core.models import TypeSegment, BillSegment, Bill
...
class BillAdminForm(forms.ModelForm):
    ...
    # TO-CUSTOMIZE: To save and create association with open data
    # def save(self, commit=True):
...
# TO-CUSTOMIZE: methods to do CRUD with open data
