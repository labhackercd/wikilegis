...
def import_file(bill_txt, bill_pk):
    ...
    # is_quote = False
    for line in lines:
        # TO-CUSTOMIZE: Set type and number if brazilian bill
        # type_id = None
        ...
        create_segment(order, bill_pk, line)
        order += 1
